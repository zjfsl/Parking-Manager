...
namespace Admin
{
        ...
        private void button1_Click(object sender, EventArgs e)
        {
         /*  errorTime = errorTime - 1;
             string username = textBox1.Text.Trim();  
              ...
              string constr = "Server=.;DataBase=SU; Integrated Security=True"; 
    ...
    class Access
    {
        ...
        public DataTable Find(string phone)
        {
            ...
            string sql = "select * from t_admin WHERE 联系电话='" + phone + "'";
            //获取表1中昵称为LanQ的内容
            OleDbDataAdapter dbDataAdapter = new OleDbDataAdapter(sql, oleDb); //创建适配对象
            DataTable dt = new DataTable(); //新建表对象
            dbDataAdapter.Fill(dt); //用适配对象填充表对象
        ...
        {
            string temp = Convert.ToString(phone);
            string sql = "select * from t_admin WHERE 联系电话='" + temp + "'";
            //获取表1中昵称为LanQ的内容
            OleDbDataAdapter dbDataAdapter = new OleDbDataAdapter(sql, oleDb); //创建适配对象
            DataTable dt = new DataTable(); //新建表对象
            dbDataAdapter.Fill(dt); //用适配对象填充表对象
            ...
            sql = "update t_admin set 姓名 ='" + temp1 + "',性别 ='" + temp2 + "',联系电话 ='" + temp3 + "',账户余额 ='" + temp4 + "',车1 ='" + temp5 + "',车2 ='" + temp6 + "',车3 ='" + temp7 + "',车4 ='" + temp8 + "',车5 ='" + temp9 + "' where 联系电话 ='" + temp + "'";
